...
export default function HomePage(): JSX.Element {
  return (
    <div className="homepage">
      ...
      <p>After getting my bachelor&apos;s degree in Computer Science from <a className="common-content-link" href="https://www.seu.edu.cn/english/" target="_blank" rel="noopener noreferrer">Southeast University</a> in 2019, I started working full-time as a frontend developer, mainly using React.</p>
